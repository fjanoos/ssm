...
% $$$ env.subject_id = 'AJ_20061121' ;
% $$$ env.subject_id = 'AR_20070227' ;
% $$$ env.subject_id = 'BC_20070518' ;
% $$$ env.subject_id = 'BG_20061205' ;
% $$$ env.subject_id = 'BK_20070613' ;
% $$$ env.subject_id = 'BZE_20070102' ;
% $$$ env.subject_id = 'CM_20070511' ;
% $$$ env.subject_id = 'CZ_20070524' ;
% $$$ env.subject_id = 'DJ_20061219' ;
% $$$ env.subject_id = 'DR_20061128' ;
% $$$ env.subject_id = 'EM_20061124' ;
% $$$ env.subject_id = 'FC_20070223' ;
% $$$ env.subject_id = 'LH_20070608' ; complete
% $$$ env.subject_id = 'MP_20070601' ;
% $$$ env.subject_id = 'NP_20061212' ;
% $$$ env.subject_id = 'SD_20070411' ;	% ??? 3x
% $$$ env.subject_id = 'SK_20061215' ;
% $$$ env.subject_id = 'SL_20070614' ;	% ??? 3x
% $$$ env.subject_id = 'SS_20070504' ;
% $$$ env.subject_id = 'SW_20070530' ;
...
if ~exist(env.preproc_file, 'file') || ~exist(env.preproc_file_2, 'file') || ~exist(env.preproc_file_3, 'file')
